    ...
    <SectionContainer>
      <div className="prose dark:prose-invert max-w-none py-8" dir="rtl">
        ...
        <p>
          ...
          سرية معلومات تسجيل الدخول الخاصة بك. أخطرنا على الفور على hello@infinique.org إذا كنت
        ...
        <p>
          ...
          الإبلاغ عن المخاوف على hello@infinique.org.
        </p>
        ...
        <p>إذا كنت تعتقد أن المحتوى ينتهك حقوقك، اتصل بـ hello@infinique.org وسنراجع على الفور.</p>
