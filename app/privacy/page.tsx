...
export const metadata = genPageMetadata({
  ...
  description:
    'Understand what personal data DearPup collects, how it is used, and the safeguards that protect it.',
  ...
  return (
    <SectionContainer>
      <div className="prose dark:prose-invert max-w-none py-8">
        ...
        <p>
          DearPup ("we," "us," or "our") is committed to protecting your privacy. This Privacy
        ...
        <p>
          <strong>If you do not agree with this Privacy Policy, please do not use DearPup.</strong>
        </p>
        ...
        <p>DearPup is for users 13 years and older.</p>
        <p>
        ...
        <p>
          We may update this Privacy Policy as needed. Continued use of DearPup means you accept the
          updated policy.
        </p>
